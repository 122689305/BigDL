...
class Optimizer(JavaValue):
    ...
    def __init__(self,
       ...
       :param optim_method: the algorithm to use for optimization,e.g. SGD, Adagrad, etc.
       :param state: a set of initial configurations for optimizer,provided as a dict e.g. configurable params include:learningRate, learningRateDecay,etc.
